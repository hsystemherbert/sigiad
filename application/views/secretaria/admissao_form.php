...
<div class="row">
	<div class="col-md-12">
		...
		<div class="col-md-10">
			<h2 style="padding-left: 15px;">CADASTRO DE TIPO DE ADMISSÃO NA IGREJA</h2>
		</div>
    </div>
</div>              
	<!-- /. ROW  -->
			...
			<div class="panel-body">
				<div class="row">
					<form action="{ACAOFORM}" method="post" role="form">
						<div class="col-md-12">
                            <input type="hidden" id="AdmissaoID" name="AdmissaoID" value="{AdmissaoID}"/>
							<div class="col-md-6">
								<div class="form-group"> 
                    				<label for="AdmissaoNome">Tipo de Admissão</label>
