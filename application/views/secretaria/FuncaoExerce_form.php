...
<div class="row">
	<div class="col-md-12">
		...
		<div class="col-md-10">
			<h2 style="padding-left: 15px;">CADASTRO DE FUNÇÕES DA IGREJA</h2>
		</div>
    </div>
</div>              
	<!-- /. ROW  -->
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="form-group"> 
                    				<label for="inputNome">Nome da função</label>
                    				<input type="text" id="inputNome" name="inputNome" value="{inputNome}" class="form-control" />
                    			</div>
							</div>
						</div>
							<div class="col-md-12"><br>
								<div style="text-align: right; padding-right: 30px;">
									<button type="submit" class="btn btn-primary"><i class="fa fa-refresh "></i> Salvar</button>
                                    <button class="btn btn-success"><i class=" fa fa-edit "></i> Editar</button>
									<button onclick="{CANCELAR}" class="btn btn-warning"><i class="fa fa-edit "></i> Cancelar</button>
