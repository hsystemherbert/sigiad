	...
	<div class="row">
        <div class="col-md-12">
            <div style="text-align: right; padding-right: 30px;">
                ...
                <button class="btn btn-warning"><i class="fa fa-edit " id="{BTN_SAIR}" onclick="{BTN_SAIR}"></i> Sair</button>
            </div>
        </div>
		<div class="col-md-12">
			<div class="panel-body">
				<div class="row">
					<form action="{ACAOFORM}" method="post" role="form">
						<div class="col-md-12">
                            <input type="hidden" id="cargoid" name="cargoid" value="{cargoid}"/>
							<div class="col-md-6">
								<div class="form-group"> 
                    				<label for="cargonome">Nome do Cargo</label>
                    				<input type="text" id="cargonome" name="cargonome" value="{cargonome}" class="form-control" />
                    			</div>
							</div>
						</div>
