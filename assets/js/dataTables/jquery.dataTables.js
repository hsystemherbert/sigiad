...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Não Existem Dados Cadastrados" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Não Existem Dados Cadastrados
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfo": "Registro _START_ de _END_ de _TOTAL_ Registros cadastrados",
